-- ============================================================================
-- AutoBid Mobile - Migration 00093: Add is_active to Auctions
-- ============================================================================
-- Adds is_active column to auctions table for Activate/Deactivate feature.
-- Updates auction_browse_listings view to expose this column.
-- ============================================================================

-- 1. Add is_active column to auctions
ALTER TABLE public.auctions
ADD COLUMN IF NOT EXISTS is_active BOOLEAN DEFAULT TRUE;

CREATE INDEX IF NOT EXISTS idx_auctions_is_active ON public.auctions(is_active);

-- 2. Update auction_browse_listings view to include is_active
-- We recreate the view from Migration 00087 but add a.is_active
...
WHERE
  -- 1. Must be LIVE (Status check only here, is_active filtering done by client)
