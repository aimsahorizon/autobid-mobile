-- ============================================================================
-- AutoBid Mobile - Migration 00144: Add chassis_number column
-- Adds chassis_number (VIN) field to listing_drafts and auction_vehicles,
-- and updates submit_listing_from_draft RPC to copy the new field.
-- ============================================================================

-- Add chassis_number to listing_drafts
ALTER TABLE listing_drafts ADD COLUMN IF NOT EXISTS chassis_number TEXT;

-- Add chassis_number to auction_vehicles
ALTER TABLE auction_vehicles ADD COLUMN IF NOT EXISTS chassis_number TEXT;

-- ============================================================================
-- Update submit_listing_from_draft to include chassis_number
-- ============================================================================
...
COMMENT ON FUNCTION submit_listing_from_draft IS 
  'Submits a complete listing draft as an auction with bidding, snipe guard, and chassis number';
