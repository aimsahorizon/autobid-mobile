...
-- Previous version showed all auctions regardless of status
-- This caused browse screen to not display live auctions
...
'Shows only live, active auctions filtered by visibility (public or accepted invite). Matches auction_browse_listings structure.';
