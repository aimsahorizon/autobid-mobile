-- ============================================================================
-- AutoBid Mobile - Migration 00063: Update submit_listing RPC for Snipe Guard
-- Updates submit_listing_from_draft to copy snipe guard settings from draft
-- ============================================================================
...
BEGIN
  ...
  -- ========================================================================
  -- STEP 2.5: Prepare snipe guard configuration (NEW)
  -- ========================================================================
...
COMMENT ON FUNCTION submit_listing_from_draft IS 
  'Submits a complete listing draft as an auction with bidding and snipe guard configuration';
