-- ============================================================================
-- AutoBid Mobile - Migration 00044: Add Tags Column for AI Detection
-- Adds tags column to listing_drafts and updates submit_listing_from_draft RPC
-- to map tags to auction_vehicles.ai_generated_tags
-- ============================================================================
...
-- Note: auction_vehicles already has ai_generated_tags column (from migration 00021)
-- We will map draft.tags to auction_vehicles.ai_generated_tags in the RPC below

-- Create/update index for faster tag searches on auction_vehicles
CREATE INDEX IF NOT EXISTS idx_auction_vehicles_tags ON auction_vehicles USING GIN (ai_generated_tags);

-- ============================================================================
-- Update submit_listing_from_draft RPC to handle tags mapping
-- ============================================================================
...
BEGIN
  ...
  -- Get bidding_type from draft (default to 'public')
...
-- ============================================================================
--
-- This migration adds AI-generated tags support:
-- 1. Adds 'tags' column to listing_drafts table for AI detection results
-- 2. Maps draft.tags to auction_vehicles.ai_generated_tags during submission
-- 3. Falls back to existing ai_generated_tags if draft.tags is NULL
-- 4. Creates GIN index on ai_generated_tags for fast tag-based searches
--
-- Tags are generated by the AI car detection service and include searchable
-- attributes like: sedan, automatic, japanese-brand, luxury, etc.
--
-- ============================================================================
