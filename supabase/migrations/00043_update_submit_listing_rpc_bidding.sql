-- ============================================================================
-- AutoBid Mobile - Migration 00043: Update submit_listing RPC for Bidding Config
-- Updates submit_listing_from_draft RPC to use bidding configuration from draft
-- ============================================================================
...
BEGIN
  ...
  -- ========================================================================
  -- USE BIDDING CONFIGURATION FROM DRAFT (NEW IN 00043)
  -- ========================================================================
...
-- ============================================================================
-- 
-- This migration updates the submit_listing_from_draft RPC to:
-- 1. Read bidding_type, min_bid_increment, deposit_amount from draft
-- 2. Read enable_incremental_bidding flag from draft
-- 3. Insert these values into the auctions table
-- 4. Maintain backward compatibility with old drafts (use fallback calculations)
--
-- Changes from 00027:
-- - Added v_bidding_type, v_min_bid_increment, v_enable_incremental_bidding variables
-- - Updated auction INSERT to include bidding configuration columns
-- - Uses COALESCE for fallback values if draft doesn't have bidding config
-- 
-- ============================================================================
