-- ============================================================================
-- AutoBid Mobile - Migration 00064: Fix submit_listing_photos
-- Ensures photos are correctly ordered globally and the first one is marked primary
-- ============================================================================
...
BEGIN
  ...
  IF v_draft.photo_urls IS NOT NULL THEN
    ...
    LOOP
      v_display_order := 0; -- Reset category-specific counter (kept for reference)
