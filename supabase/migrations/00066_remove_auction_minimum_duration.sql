-- ============================================================================
-- AutoBid Mobile - Migration 00066: Remove Auction Minimum Duration
-- Removes the 1-day minimum validation for testing purposes
-- ============================================================================
...
BEGIN
  ...
  -- Validate auction duration (removed minimum, max 90 days for testing)
