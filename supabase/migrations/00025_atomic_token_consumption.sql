-- ============================================================================
-- AutoBid Mobile - Migration 00025: Atomic Token Consumption in RPC
-- Consume listing token INSIDE submission RPC for atomicity
-- Prevents token loss if submission fails
-- ============================================================================
...
BEGIN
  ...
  -- Validate required fields before consuming token
  ...
  -- ========================================================================
  -- STEP 1: Consume listing token ATOMICALLY (before creating auction)
  -- ========================================================================
