...
class InstallmentController extends ChangeNotifier {
  ...
  void _subscribeToRealtime(String transactionId, String planId) {
    ...
    _planSubscription = _datasource.streamInstallmentPlan(transactionId).listen(
      ...
      onError: (e) =>
          debugPrint('[InstallmentController] Plan stream error: $e'),
    );
    ...
    _paymentsSubscription = _datasource.streamPayments(planId).listen(
      (payments) {
        ...
        debugPrint(
          '[InstallmentController] Stream emitted ${payments.length} payments',
        );
        _payments = payments;
        notifyListeners();
      },
      onError: (e) =>
          debugPrint('[InstallmentController] Payments stream error: $e'),
    );
  }
  ...
  Future<bool> createPlan({
    ...
    try {
      ...
      if (_plan != null) {
        // Payments are auto-generated by DB trigger on plan insert;
        // fetch them via the RPC
