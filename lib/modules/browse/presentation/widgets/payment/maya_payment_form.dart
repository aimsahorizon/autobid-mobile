...
class MayaPaymentForm extends StatefulWidget {
  final double amount;
  final VoidCallback onCancel;
  final Function(String phoneNumber) onSubmit;
  final bool isProcessing;

  const MayaPaymentForm({
    super.key,
  ...
  @override
  State<MayaPaymentForm> createState() => _MayaPaymentFormState();
}

class _MayaPaymentFormState extends State<MayaPaymentForm> {
    ...
    return Row(
      children: [
        Container(
          ...
          height: 48,
          decoration: BoxDecoration(
            color: const Color(0xFF52B44B).withValues(alpha: 0.1),
    ...
    return TextFormField(
      ...
      validator: (value) {
        if (value == null || value.isEmpty) {
          return 'Please enter your Maya number';
        }
        if (value.length != 11) {
