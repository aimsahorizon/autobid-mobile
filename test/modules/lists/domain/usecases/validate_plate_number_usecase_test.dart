// ==============================================================================
// 🧪 CLEAN ARCHITECTURE TEST: ValidatePlateNumberUseCase
...
void main() {
  late ValidatePlateNumberUseCase usecase;
  ...
  setUp(() {
    ...
    // usecase = ValidatePlateNumberUseCase(mockRepository);
  });

  // ============================================================================
  // 🔹 STANDARD BEHAVIOR TESTS
  // ============================================================================
  group('🔹 STANDARD BEHAVIOR - ValidatePlateNumberUseCase', () {
