// ==============================================================================
// 🧪 CLEAN ARCHITECTURE TEST: ConsumeBiddingTokenUsecase
...
void main() {
  late ConsumeBiddingTokenUsecase usecase;
  ...
  setUp(() {
    ...
    // usecase = ConsumeBiddingTokenUsecase(mockRepository);
  });

  // ============================================================================
  // 🔹 STANDARD BEHAVIOR TESTS
  // ============================================================================
  group('🔹 STANDARD BEHAVIOR - ConsumeBiddingTokenUsecase', () {
