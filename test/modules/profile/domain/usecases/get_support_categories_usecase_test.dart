// ==============================================================================
// 🧪 CLEAN ARCHITECTURE TEST: GetSupportCategoriesUsecase
...
void main() {
  late GetSupportCategoriesUsecase usecase;
  ...
  setUp(() {
    ...
    // usecase = GetSupportCategoriesUsecase(mockRepository);
  });

  // ============================================================================
  // 🔹 STANDARD BEHAVIOR TESTS
  // ============================================================================
  group('🔹 STANDARD BEHAVIOR - GetSupportCategoriesUsecase', () {
