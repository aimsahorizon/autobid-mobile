// ==============================================================================
// 🧪 CLEAN ARCHITECTURE TEST: UpdateTicketStatusUsecase
...
void main() {
  late UpdateTicketStatusUsecase usecase;
  ...
  setUp(() {
    ...
    // usecase = UpdateTicketStatusUsecase(mockRepository);
  });

  // ============================================================================
  // 🔹 STANDARD BEHAVIOR TESTS
  // ============================================================================
  group('🔹 STANDARD BEHAVIOR - UpdateTicketStatusUsecase', () {
