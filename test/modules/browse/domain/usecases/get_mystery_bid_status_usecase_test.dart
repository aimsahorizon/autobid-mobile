// ==============================================================================
// 🧪 CLEAN ARCHITECTURE TEST: GetMysteryBidStatusUseCase
...
void main() {
  late GetMysteryBidStatusUseCase usecase;
  ...
  setUp(() {
    ...
    // usecase = GetMysteryBidStatusUseCase(mockRepository);
  });

  // ============================================================================
  // 🔹 STANDARD BEHAVIOR TESTS
  // ============================================================================
  group('🔹 STANDARD BEHAVIOR - GetMysteryBidStatusUseCase', () {
